...
// //                       Play History
// //                     </button>
// //                     <button className="bg-yellow-500 text-white py-2 px-4 rounded-lg mr-2">
// //                       History Generated (XML)
// //                     </button>
// //                     <button className="bg-red-500 text-white py-2 px-4 rounded-lg mr-2">
// //                       Submitted Code
// //                     </button>
